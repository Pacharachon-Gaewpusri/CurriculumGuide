...
export default function DevSci() {
	...
	return (
		<main className="DevSci-page">
			<header>
				<h1>Development Science Learning Materials</h1>
				<p>All non-electronics and electronics resources for the Development Science major.</p>
			</header>
			...
			<div className="resource-filters">
				<input
					...
					aria-label="Search Development Science learning materials"
				/>
			...
			{!filteredMaterials.length && <p>No Development Science materials match your search.</p>}
